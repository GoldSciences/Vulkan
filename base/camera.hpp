...
public:
	...
	// Update camera passing separate axis data (gamepad). Returns true if view or position has been changed.
	bool														updatePad					(glm::vec2 axisLeft, glm::vec2 axisRight, float deltaTime)	{
		bool															retVal		= false;

		if (type == CameraType::firstperson) {
			// Use the common console thumbstick layout. Left = view, right = move.
