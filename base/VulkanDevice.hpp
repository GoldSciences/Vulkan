...
{	
	struct VulkanDevice
	{
		...
		// 
		// Returns index of the queue family index that matches the flags.  Throws an exception if no queue family index could be found that supports the requested flags
		...
		// 
		// Returns VkResult of the device creation call
		...
		*/
		...
		// 
		// Source and destionation pointers must have the approriate transfer usage flags set (TRANSFER_SRC / TRANSFER_DST)
