...
#undef STR
			...
			)
		{
			...
			case VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL			: srcMask = VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT;					break;	// Image is a color attachment.			Make sure any writes to the color buffer have been finished
			case VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL	: srcMask = VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT;			break;	// Image is a depth/stencil attachment.	Make sure any writes to the depth/stencil buffer have been finished
			case VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL				: srcMask = VK_ACCESS_TRANSFER_READ_BIT;							break;	// Image is a transfer source.			Make sure any reads from the image have been finished
			case VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL				: srcMask = VK_ACCESS_TRANSFER_WRITE_BIT;							break;	// Image is a transfer destination.		Make sure any writes to the image have been finished
